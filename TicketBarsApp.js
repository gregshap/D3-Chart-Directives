  ...
  VanDash2App.controller('VanCtrl',function VanCtrl($scope,$http) {
    ...
    //Reformat from the web api format with items and junk, into arrays
      ...
      var reformatVanResponse= function(data){
    ...
    $scope.getData = function () {
          $http({
            method: 'GET',
            url:'/data/ticket-chart-formatted.json'
          }).
          success(function (data) {
            // attach this data to the scope
            $scope.sourcedata = reformatVanResponse(data);
  ...
  VanDash2App.directive('dash2Visualization', function() {
        return {
          restrict: 'E',
          scope: {
            val: '='
          ...
          link: function (scope, element, attrs) {
              ...
              ******************************************************/
              ...
              scope.$watch('val', function (newVal, oldVal) {
                ...
                //TODO: Note the dependence on 'items' here -> this should get cleaner with an actual angular service
                var data = newVal["chartpoints"];
